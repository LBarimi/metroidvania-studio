...
try {
  ...
  assertWorkspaceUnchanged(afterReadOnlyClick, beforeCameraPreview, 'Game view must not edit the map.');
  ...
  assertWorkspaceUnchanged(afterCameraPreview, beforeCameraPreview);
