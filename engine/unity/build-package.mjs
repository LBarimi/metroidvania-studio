...
export function buildPackage(destination) {
  ...
  const source = path.join(here, 'Assets/MetroidvaniaStudioIntegration');
  ...
  const output = destination ? path.resolve(destination) : path.join(here, `Builds/MetroidvaniaStudio-Unity-${version}.unitypackage`);
