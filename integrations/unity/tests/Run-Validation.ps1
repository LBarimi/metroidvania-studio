...
. (Join-Path $studio 'metroidvania-studio/Runtime-Tools.ps1')
...
if ($Connection) {
    ...
    try {
        ...
        & (Join-Path $studio 'metroidvania-studio/Run-MetroidvaniaStudio.ps1') -NoBrowser -Project $workspace -Port $Port
        $started = $true
        ...
        if ($started) { & (Join-Path $studio 'metroidvania-studio/Stop-MetroidvaniaStudio.ps1') -Project $workspace -Port $Port }
