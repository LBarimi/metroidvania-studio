...
internal static class Program
{
    ...
    {
        public string Local => Path.Combine(Root, "MetroidvaniaStudio", ".local");
    ...
    public static async Task<int> Main(string[] args)
    {
        try
        {
            ...
            using (await Lock(options))
            {
                ...
                string build = ResolveBuild(options), dll = Path.Combine(build, "MetroidvaniaStudio/Server/MetroidvaniaStudio.Server.dll");
    ...
    private static string ResolveBuild(Options options)
    {
        ...
        if (options.BuildDirectory == null && !File.Exists(Path.Combine(build, "MetroidvaniaStudio/Server/MetroidvaniaStudio.Server.dll")))
        {
        ...
        foreach (string file in new[] {
            "MetroidvaniaStudio/Server/MetroidvaniaStudio.Server.dll", "MetroidvaniaStudio/Server/MetroidvaniaStudio.Server.deps.json", "MetroidvaniaStudio/Server/MetroidvaniaStudio.Server.runtimeconfig.json",
            "MetroidvaniaStudio/Launcher/MetroidvaniaStudio.Launcher.dll", "MetroidvaniaStudio/Launcher/MetroidvaniaStudio.Launcher.deps.json", "MetroidvaniaStudio/Launcher/MetroidvaniaStudio.Launcher.runtimeconfig.json",
            "MetroidvaniaStudio/dist/index.html", "MetroidvaniaStudio/dist/app.js", "MetroidvaniaStudio/dist/map-canvas.js", "MetroidvaniaStudio/Localization/MetroidvaniaStudioLocale.csv", "Samples/catalog.json" })
