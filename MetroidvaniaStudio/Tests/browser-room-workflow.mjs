...
try {
  ...
  await page.screenshot({ path: path.join(repository, 'Logs/RoomWorkflow-Edit.png') });
  ...
  await page.screenshot({ path: path.join(repository, 'Logs/RoomWorkflow-Camera.png') });
  ...
  await page.screenshot({ path: path.join(repository, 'Logs/RoomWorkflow-Failure.png') });
